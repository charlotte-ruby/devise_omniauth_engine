Feature: generating devise_omniauth_engine files
  ...
  Scenario: run install generator
    ...
    And a timestamped file named 'create_profiles.rb' is created in the '/db/migrate/' directory
    And a timestamped file named 'create_profile_locations.rb' is created in the '/db/migrate/' directory
    And a timestamped file named 'create_profile_urls.rb' is created in the '/db/migrate/' directory
    ...
    And the file "app/models/user.rb" contains "has_one :profile"    
